...
public enum ExchangeType {
    ...
    OKEXV3("OKEX","OKEXV3",10),
    BINANCEUS("BINANCE","BINANCEUS",11),
    BINANCEUSSTREAM("BINANCE","BINANCEUSSTREAM",12),
    BINANCEFUTURESTREAM("BINANCE","BINANCEFUTURESTREAM",13),
    BINANCEUSDSFUTURE("BINANCE","BINANCEUSDSFUTURE",14),
    BINANCECOINFUTURE("BINANCE","BINANCECOINFUTURE",15),
    BINANCECOINFUTURESTREAM("BINANCE","BINANCECOINFUTURESTREAM",16),
    ;
