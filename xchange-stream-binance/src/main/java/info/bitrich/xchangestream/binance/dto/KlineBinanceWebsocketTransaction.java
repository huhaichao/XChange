...
public class KlineBinanceWebSocketTransaction extends ProductBinanceWebSocketTransaction {
    ...
    public KlineBinanceWebSocketTransaction(
        ...
        this.binanceKline = new BinanceKline(BinanceAdapters.adaptSymbol(symbol), org.knowm.xchange.dto.marketdata.KlineInterval
                .parseFromCode(klineInterval.code()), getParameters(kline));
    }
